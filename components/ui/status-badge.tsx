...
const statusBadgeVariants = cva(
  ...
  ].join(" "),
  {
    variants: {
      status: {
        // Generic status
        success: "bg-purple-500/10 text-[var(--ds-status-success-text)]",
        ...
        completed: "bg-purple-500/10 text-[var(--ds-status-success-text)]",
      ...
      {showDot && (
        <span
          className={cn(
            ...
            {
              "bg-purple-400": status === "success" || status === "completed",
