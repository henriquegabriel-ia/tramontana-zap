...
export function InternationalPhoneInput({
  ...
  return (
    <div className={cn("w-full", className)}>
      <div
        className={cn(
          "flex w-full items-stretch rounded-xl border border-slate-700 bg-slate-800",
          disabled && "opacity-60"
        )}
      >
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <button
              ...
              disabled={disabled}
              className={cn(
                "flex shrink-0 items-center gap-2 rounded-l-xl border-r border-slate-700 px-3",
          ...
          <PopoverContent
            ...
            sideOffset={8}
            className={cn(
              "w-[340px] border-slate-700 bg-slate-900 p-0 text-slate-100 shadow-xl",
              "rounded-xl"
            )}
          >
            <Command>
        ...
        <div className="flex shrink-0 items-center border-r border-slate-700 bg-slate-800 px-3 text-sm text-slate-200">
          +{country.dialCode}
        </div>
        ...
        <input
          ...
          className={cn(
            "min-w-0 flex-1 rounded-r-xl bg-slate-800 px-4 py-3 text-white placeholder:text-slate-500",
