            ...
            isConfigured ? (
              <>
                <StatusBadge status={isSmartZap ? 'success' : 'warning'} showDot>
                  {isSmartZap ? 'Tramontana Zap' : 'Outro sistema'}
                </StatusBadge>
            ...
            <p className="text-[11px] text-[var(--ds-text-secondary)]">
              {currentlyUsing === 'number' ? (
                ...
                <>
                  ...
                  Configure aqui para todos os números usarem o Tramontana Zap automaticamente.
                </>
              )}
            </p>
          </div>
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          {!isConfigured || !isSmartZap ? (
            <button
              ...
              title={webhookSubscription && !webhookSubscription.ok ? 'Configure as credenciais antes de ativar' : 'Configurar Tramontana Zap como webhook WABA'}
            >
              {webhookSubscriptionMutating ? (
              ...
              Ativar Tramontana Zap para WABA
            </button>
          ) : (
